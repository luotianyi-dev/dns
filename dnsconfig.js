...
D("luotianyi.dev", REG_NONE, DnsProvider(DSP_CF_LTY), TTL_DEFAULT,
  ...
  TXT  ("_dmarc", COMMON_DMARC),
  TXT  ("google._domainkey", DKIM_GOOGLE),
  ...
  // Mailgun - notification.luotianyi.dev
  MX   ("notification", 10,   "mxa.mailgun.org."),
  MX   ("notification", 20,   "mxb.mailgun.org."),
  TXT  ("notification",       "v=spf1 include:mailgun.org ~all."),
  TXT  ("_dmarc.notification", COMMON_DMARC),
  TXT  ("smtp._domainkey.notification", DKIM_MAILGUN),
